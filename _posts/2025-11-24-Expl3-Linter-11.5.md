...
The confidence of each dynamic edge is either the minimum confidence along the
path from the definition to the call or the confidence of the definition
statement, whichever is lower.
