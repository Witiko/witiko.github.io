...
for expl3 programmers_][8] ([slides][9]):
  ...
  {% include youtube.html id="ImCoKj_kLw4?start=3023&amp;end=5615&amp;feature=oembed"
     description="“TUG 2025 – Day 2 Saturday Stream” on YouTube, my talk starts at 50:23" %}
...
During the following coffee break, CV Radhakrishnan – a
founding member of [the Indian TeX Users Group][10], [River Valley
Technologies][25], and STMDocs  – offered to help secure additional
...
_expltools_' pipeline approach – tokenizing the text first, then
