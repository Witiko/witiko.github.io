---
layout: post
title: "Static analysis of expl3 programs (8⅞): Expltools goes to India"
tags:
  - expl3
  - LaTeX
  - programming
...
Early in the morning on July 16, I took a train from Brno to Prague.
  ...
  {% include image.html url="20250716_054327.jpg"
     description="Getting up-to-date on the current gaming news with the video games magazine LEVEL" %}
...
to the conference room and receiving my welcome package there.
  ...
  {% include image.html url="20250718_094628.jpg"
     description="A welcome package, which included (among other things) a book for LaTeX beginners" %}
...
the talk went smoothly. During the Q&mp;A session, the questions asked
...
grammar their (La)TeX parser uses][11], which struck me as more elegant than
...
Bhattathiri][13].
  ...
  {% include image.html url="20250720_180055.jpg"
     description="Thành's request: the Vietnamese text “Nhà khủng lồ” (“a giant house”) drawn by Narayana" %}

Shortly after the workshop, I said my goodbyes and left for the Trivandrum
airport.

  {% include image.html url="20250720_200822.jpg"
     description="Statues of a Kathakali dancer (top) and Nandi, the sacred bull and vehicle of Lord Shiva" %}
...
for their camaraderie throughout the conference.
 ...
 [10]: https://tug.org.in/
 [11]: https://github.com/overleaf/overleaf/blob/main/services/web/frontend/js/features/source-editor/lezer-latex/latex.grammar
